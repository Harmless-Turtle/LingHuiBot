...
fec_buildId_path = OPENDATA / "data"  / "furry_system"/ "fec" / "fec_buildID.json"
fec_images_path = OPENDATA / "data"  / "furry_system"/ "fec" / "images"
...
ensure_files_exist(
    ...
    normal_data=[None, None, [], None, None, None, None,{},None]
)
