...
如果出现如上信息，即意味着您已经成功配置了CookieCloud，并且现在凌辉Bot的bilichat插件已经可以使用CookieCloud获取用户Cookie了。
...
````
{
	...
	"cookie_clouds": [{
		...
		"uuid": "86fUTo28vW8SZyX6RNFpQS",<br>
		"password": "dFqTThEmVFWfAqaXAXnwCA"<br>
	}]<br>
}<br>
````
